(() => {
  ...
  const SPECS = [
    ...
    {id:'insane-psychotic-saw-35',name:'Psychotic Saw',presentation:'30 Serv',brand:'Insane Labz',category:'Pre Entreno',price:166000,file:'1Qv2fYGpGEfUysMI_htcrCnD6Nb3EM8xV'},
  ...
  if (changed) console.info('[Lift] Insane Labz cargado sin observadores ni intervalos.');
})();
